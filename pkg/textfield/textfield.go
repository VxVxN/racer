...
func NewTextField(fontFace *text.GoTextFace, bounds image.Rectangle, multilines bool) *TextField {
	return &TextField{
		bounds:     bounds,
...
func (t *TextField) textFieldPadding() (int, int) {
	...
	return 4, (int(t.fontFace.Size) - int(m.HLineGap+m.HAscent+m.HDescent)) / 2
}
